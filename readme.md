...
2. **双击**该值
3. 标签立即应用到选中的歌曲
4. 顶部显示绿色成功提示：`✓ 已应用 '反差增坏' 到 情感表现方式 字段 (1 个文件)`
...
Tag Browser 显示所有已存在的特质，确保标签一致性。
